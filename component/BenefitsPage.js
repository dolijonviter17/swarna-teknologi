  ...
  return (
    <section className="bg-gray-100 text-blue-100 body-font">
      <div className="container px-5 py-24 mx-auto items-center md:flex-row flex-col">
        <div className="flex flex-col md:pr-10 px-20 md:mb-0 mb-6 pr-0 w-full sm:items-center md:text-center md:w-auto md:text-left text-center">
        ...
        <div className="flex flex-wrap sm:-m-4 px-20 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
