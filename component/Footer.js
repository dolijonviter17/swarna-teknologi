  ...
  return (
    <footer className="bg-blue-100 text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div className="w-96 flex-shrink-0 px-20 md:mx-0 mx-auto text-center md:text-left">
          ...
          <p className="mt-2 text-sm text-white pt-6">
            Find more options when looking for a software developer.
            Pay-as-you-go, of course!
          </p>
          <span className="inline-flex sm:ml-auto sm:mt-0 pt-6 justify-center sm:justify-start">
        ...
        <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            <h2 className="title-font font-bold text-white tracking-widest mb-3">
              Service
            </h2>
            <nav className="list-none mb-10">
              <li>
                <a className="text-blue-300 text-sm hover:text-gray-800">
                  Graphic Design
                </a>
              </li>
              <li>
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              <li>
                <a className="font-medium text-blue-300 text-sm hover:text-gray-800">
                  About Swarna Studio
                </a>
              </li>
              <li>
              ...
              <li>
                <a className="text-blue-300 text-sm hover:text-gray-800">FAQ</a>
              </li>
